...
void setup()
{
  ...
  Serial.begin(9600);  //Begin the Serial with 9600 baud rate
}
...
void loop()
{
  ...
  Serial.print(lightLevel);
  Serial.print("  Calibrated Light Level: ");
  Serial.println(calibratedlightLevel);   // println the calibrated light level
